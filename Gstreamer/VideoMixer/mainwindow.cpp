...
GstElement *videomixer,*pipeline;
...
void MainWindow::startVideo()
{
    ...
    //Elements de sortida
    GstElement *bin_pgm, *queue_12, *queue_22, *tee_pgm, *queue_pgm, *sink_pgm;
    ...
    */
    ...
    sink_1 = gst_element_factory_make ("xvimagesink", "sink_font1");
    sink_2 = gst_element_factory_make("xvimagesink", "sink_font2");
    ...
    g_object_set (G_OBJECT (source_3), "location",c_nom_fitxer, NULL);
    */
...
{
    //---------------------------------------------------------------
    //Una cosa similar a aix hauria de permetre fer el MIX
    GstPad *mixerpad=gst_element_get_pad(videomixer,"sink_1");
    g_object_set (G_OBJECT(mixerpad), "alpha",double(value),NULL);
}
